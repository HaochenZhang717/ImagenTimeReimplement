...
from utils.utils import save_checkpoint, restore_state, create_model_name_and_dir, print_model_params, \
    log_config_and_tags
from utils.utils_data import build_dataloader_var
...
def main(args):
    ...
    train_loader, test_loader = build_dataloader_var(args.batch_size, args.dataset, args.seq_len)
